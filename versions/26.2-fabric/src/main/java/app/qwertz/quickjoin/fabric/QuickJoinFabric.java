...
public class QuickJoinFabric implements ClientModInitializer {
    ...
    private void registerKeyBindings() {
        ...
        favoritesKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
    ...
    private void registerCommands() {
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> {
            ...
            dispatcher.register(ClientCommands.literal("quickjoin")
    ...
    public static void refreshAlias() {
        ...
        aliasNode = commandDispatcher.register(ClientCommands.literal(alias)
                .executes(ctx -> executeOpenQuickJoin(ctx.getSource())));
    }
    ...
    private void registerTickHandler() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (pendingScreen != null && client.gui.screen() == null) {
    ...
    public static void openConfigScreen(Screen parent) {
        ...
        client.execute(() -> client.gui.setScreen(QuickJoinConfig.createConfigScreen(parent)));
    }
