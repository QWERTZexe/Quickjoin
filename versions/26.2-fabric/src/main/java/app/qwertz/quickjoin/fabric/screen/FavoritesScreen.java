...
public class FavoritesScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.literal("Back"), btn -> Minecraft.getInstance().gui.setScreen(new QuickJoinScreen("QuickJoinGui")))
                .bounds(startX, this.height / 2 + 90, 108, 20)
                .build());
        addRenderableWidget(Button.builder(Component.literal("Close"), btn -> Minecraft.getInstance().gui.setScreen(null))
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        context.centeredText(font, Component.literal("§eFavorites"), width / 2, height / 2 - 110, 0xFFFFFF);
